...
if len(sys.argv) != 2:
    print(
        "Usage (needs one argument): python summarize_training.py results_training/icentia11k_resnet18_7_bs32_lr1e-3_wd1e-4_ep20"
    )
    sys.exit()
...
processed_metrics = processed_metrics.round(3)
