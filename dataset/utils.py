...
# For building PTB-XL dataset in this repository
# Extract id from the header. (additional implementation)
def get_id(header):
    sample_id = None
...
def get_labels_from_filename(header_file_name):
    labels = list()
...
# Below is the implementation for the PhysioNet/CinC Challenge 2021
# For building PTB-XL dataset in this repository
# https://github.com/physionetchallenges/python-classifier-2021/blob/main/helper_code.py
